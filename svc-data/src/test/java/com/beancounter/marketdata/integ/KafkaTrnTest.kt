...
class KafkaTrnTest {
    ...
    fun exportFileImported() {
        ...
        val trnSize = createTrns(portfolio)
        ...
        importRows(fileName, portfolio, trnSize + 1) // Include a header row.
        ...
        assertThat(imported).hasSize(trnSize)
    }
    ...
    private fun createTrns(portfolio: Portfolio): Int {
        val provider = "BC"
        val batch = "batch"
    ...
    private fun exportDelimitedFile(forPortfolio: Portfolio): String {
        ...
        val fileName = "${forPortfolio.id}.txt"
